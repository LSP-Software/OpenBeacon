...
11. When using types we should be careful about how we define them.
  ...
  g. Do not prefer inline types by default. Choose inline or extracted types based on readability, and when a function type is extracted instead of inlined, define it at the bottom of the file.
